    ...
    <div  class="d-flex justify-content-center align-items-center p-3 vh-100">
        <div class="login-container">
            ...
            <div class="login-form">
                <h3 class="title text-center mb-4 pb-2 ps-0">User Login</h3>

                <form method="POST" action="code.php">
                    <div class="mb-3">
                    <input type="text" class="form-control" id="user"  name="email_username" placeholder="User Name">
                    </div>
                    <div class="mb-3">
                    <input type="password" class="form-control" id="pwd" name="password" placeholder="Password">
                    </div>
                    <button type="submit" class="btn login-submit-btn" name="login" >Submit</button>
                </form>
