 ...
 <style>
  ...
  <body>
    ...
    <div class="container">
      ...
      <a href="/invoice/invoice-list.php" class="create-button">Back</a>
      </div>
          ...
          <tbody>
              ...
              if($result){
                while($row = mysqli_fetch_assoc($result))
                {
                  ...
                  <td>'.$company_name.'</td>
                  <td>'.$order_id.'</td>
                  <td class="text-truncate">'.$clientname.'</td>
                  <td>'.$amount.'</td>
                  <td>'.$user.'</td>
                  <td>
                  <a href="/invoice/pdf/'.$str.'.php?pdf_id='.$id.'" class="tbl-btn download me-1" data-bs-toggle="tooltip" data-bs-placement="top" title="PDF">
