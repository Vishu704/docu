...
$clientname = mb_convert_case($row['clientname'], MB_CASE_TITLE, "UTF-8");
// $str = str_replace(' ', '-', $clientname);
$email = strtolower($row['email']);
$contact = $row['contact'];
$address = mb_convert_case($row['address'], MB_CASE_TITLE, "UTF-8");
$card = $row['card']; 
...
<html>
<head>
    <title><?php echo $company_name ?> - Pdf</title>
	<meta charset="utf-8" />
    ...
    <div class="page-size">
        <div id="element-to-print">
            ...
            <!-- Sample Table -->
                ...
                <img src="../images/daphnis-logo.png" alt="" class="daphnislogo"> 
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        ?>
                        <!-- <p class="m-0"><b>Note:</b><?php echo $comments ?></p> -->
                        
                        <br>
                        <h3 class="center-title fs-5 mt-4">AUTHORIZATION</h3>  <br> 
                        <p>I <?php echo $clientname ?> hereby authorize <b>Daphnis Technologies LTD</b> to charge the above credit card for fees associated with services provided. I agree that the onetime charge will be applied to my credit card by Daphnis Technologies LTD. I agree that if I have any problems or questions regarding my account or any services provided by Daphnis Technologies LTD, I will contact Daphnis Technologies LTD for assistance. I guarantee and warrant that I am the legal card holder for this credit card and that I am legally authorized to enter into this credit card billing agreement with Daphnis Technologies LTD.</p>
                    </div>
                ...
                <img src="../images/daphnis-footer.png" alt="" class="w-100 d-footer-1">
            ...
            <br>
            <div class="border d-2">
                <br>
                <h3  class="center-title fw-bold"><u>Terms & Conditions:</u></h3>  <br>
                ...
                <p> <u class="fw-bold">A. Capacity and Authority to contract:</u>  CUSTOMER represents that he/she is of legal age of majority in the state of residence and, if required can enter this contract.</p>
                <p> <u class="fw-bold">B. Description of Product & services:</u>: MERCHANT is primarily a third-party independent service provider of the various products and offers online services for a large set of hardware and software products.</p>
                <p> <u class="fw-bold">C. Term: </u> This agreement is effective unless terminated and is valid for the period of term established above.</p>
                <p> <u class="fw-bold">D. Payment: </u>Payment shall be made to Merchant. By signing this End User Service Agreement, CUSTOMER authorize that the payment was charged with his/her permission and MERCHANT has explained every aspect of the Product and services under this End User Service Agreement. CUSTOMER with free will and consent has made the payment from the Card/Cheque/Cash in favour of MERCHANT.</p>
                <p> <u class="fw-bold">E. Independent Developer and seller: </u> MERCHANT is a computer/software repair/setup company who provides phone support for computer and other peripheral devices. Merchant also provides web development services as and when required for the computers/servers.</p>
                <p> <u class="fw-bold">F. Limited Liability: </u> The parties understand and agree that MERCHANT and its employees, subcontractors, and its agents assume no liability or responsibility for the cost of repairing or replacing any equipment, software, or personal property, including intellectual property lost or damaged, either current or arising in the future, or any consequential damage of any nature incurred because of the services rendered to the CUSTOMER. The CUSTOMER agrees that in the event the CUSTOMER incurs any loss because of the services rendered it pursuant to this agreement, the MERCHANT, its employees, subcontractors, and agents is liable only to the extent of the MERCHANT charge to this CUSTOMER for this Agreement. </p>
                
            
                <img src="../images/daphnis-footer.png" alt="" class="w-100" style="margin-top: 160px;">
            </div>

            <br>
            <div class="border d-2">
                <p> <u class="fw-bold">G. Right to refuse, suspend or terminate service: </u>MERCHANT reserves the right to refuse, suspend or terminate service to any user for any reasons related to improper/illegal use of computers in the service plan. In the event of such refusal or termination, a refund for time remaining will be made on a pro-data basis and will credited to CUSTOMER account within 72 hours of termination.</p>
                <p> <u class="fw-bold">H. Transfer: </u>This agreement is non transferrable without the prior approval of the MERCHANT. The new end user receiving the transferred agreement must agree to all the End User Service Agreement terms.</p>
                <p> <u class="fw-bold">I. Refunds and Cancellation: </u>That both the parties agree to the following refund/cancellation schedule after the signature of agreement. MERCHANT agrees to waive charges incurred if we are unable to resolve the issue. If the issue has been resolved and the CUSTOMER wishes to cancel, MERCHANT may charge a minimum service delivery fee and refund the outstanding amount with the schedule shown below. However, cost incurred by MERCHANT on behalf of CUSTOMER in getting license key for any software shall not be reimbursed by the MERCHANT. CUSTOMER is requested to call support number to initiate any refund/cancellation within 14 days of purchase for refund.</p>
                <p> <u class="fw-bold">J. Entire Agreement: </u>This End User Service Agreement is the entire agreement between the CUSTOMER and MERCHANT, and it supersedes all prior or oral or written communications, proposals, and representations with respect to support covered by this End User Service Agreement.</p>
                <br>
                <br>
                <br>
                <br>
                ...
                <br>
                <br>
                <img src="../images/daphnis-footer.png" alt="" class="w-100">

            </div>
            <br>
            <div class="border bottom-bordered p-0">
                <!-- Sample Table -->
                    <div style="padding: 30px  30px 10px 30px;">
                        <img src="../images/daphnis-logo.png" alt="" class="daphnislogo"> 
                        <h3  class="center-title"> <u> Service Delivery Confirmation</u> </h3> <br>
                    ...
                    <div style="padding: 30px  30px 10px 30px;">
                            <div class="row g-5">
                                <div class="col-6"><div class="info-container">
                                    <h6 class="text-center"><u>Merchant Details</u></h6>
                                    <h6 style="font-size: 17px; font-weight: bold;">DAPHNIS TECHNOLOGIES LTD
                                        2nd Floor, College House, 17 King Edwards Road, Ruislip, London, HA4 7AE, UK
                                    </h6>

                                    <p class="mb-1" style="font-size: 14px;"><b>Website: </b>www.daphnistechnologies.com</p>
                                    <p class="mb-1" style="font-size: 14px;"><b>Email: </b>support@daphnistechnologies.com</p>
            ...
            <div class="border bottom-bordered" style="min-height: 1040px;">
                <h3  class="center-title"> <u> Services Agreement</u> </h3> <br>
            ...
            <div class="border bottom-bordered"  style="min-height: 1040px;">
                <h3  class="center-title mt-4 mb-3"> <u> Agreement, Terms & Conditions:</u> </h3> <br>
                ...
                <ol>
                    ...
                    <li><u>Terms of Use: </u><br> DAPHNIS TECHNOLOGIES LTD ("Daphnis Technologies LTD," "we," "us," and "our") reserves the right to change, modify, add, or remove any of the terms and conditions contained in above policies or guidelines governing the Site or Services, at any time and in its sole discretion. Any changes will be effective upon posting of the revisions on the Site. All notice of changes to this Policy will be posted on the Site for thirty (30) days. You are responsible for reviewing the notice and any applicable changes. Changes to referenced policies and guidelines may be posted without notice to you. </li>
                    <li>You’re continued use of this site and the services, any changes or updates posted by Daphnis Technologies LTD will constitute your acceptance of such changes or modifications. If you do not agree to any changes to this participation agreement, do not continue to use the services or this site. If you have any questions or concerns, please contact us at “support@daphnistechnologies.com".</li>
                ...
                <p class="mt-4">As a standard company policy, we will follow up with you (client) for 3 business days. If we do not get any feedback or any complaints, we will go ahead and close the case as RESOLVED and the payment will be processed. You (client) will not DISPUTE the transaction in such cases.</p>
            </div>
            <br>
            <div class="border bottom-bordered"  style="min-height: 1040px;">
                <br>
                <br>
                <p><b>How to contact</b> DAPHNIS TECHNOLOGIES LTD:</p>
                ...
                <b class="mb-2"><b>Daphnis Technologies LTD</b> </b>
                <p class="mb-0 mt-3"><b>Website: </b> www.daphnistechnologies.com </p>
                <p class="mb-0"><b>Email: </b>support@daphnistechnologies.com</p>   
                <p class="mb-3"><b>Address: </b> 2nd Floor, College House, 17 King Edwards Road, Ruislip, London, HA4 7AE, UNITED KINGDOM</p>  
                <p><b>To advise</b> DAPHNIS TECHNOLOGIES LTD <b>of your new email address</b></p> 
                <p>To let us know of a change in your email address where we should send notices and disclosures electronically to you, you must send an email message to us atsupport@daphnistechnologies.com and in the body of such request, you must state: your previous email address, your new email address. We do not require any other information from you to change your email address.</p>
                <p>To inform us that you no longer wish to receive future notices and disclosures in electronic format you may:</p>
                <ul><li>Send us an email at support@daphnistechnologies.com and in the body of such request you must state your email, full name, mailing address, and telephone number. We do not need any other information from you to withdraw consent. </li></ul>
            </div>
            ...
            <div class="border bottom-bordered" style="border-color: #fff !important;">
                <img src="../images/daphnis-logo.png" alt="" class="daphnislogo"> 
                <h3  class="center-title mt-4 mb-3"> <u> CUSTOMER FEEDBACK FORM</u> </h3> <br>   

                <p>We at Daphnis Technologies LTD, want to thank you for giving us the opportunity to serve you. Please help us by taking a couple of minutes to tell us about your experience. We appreciate your business and want to make sure we meet your expectations</p>
                ...
                <p class="text-center">Would you recommend our product or service to others?	&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;	YES	 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;	 &nbsp; &nbsp;NO </p>
           
                <img src="../images/daphnis-footer.png" alt="" class="w-100" style="margin-top: 150px;">
