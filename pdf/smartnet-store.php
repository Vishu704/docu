    ...
    <div class="page-size">
        <div id="element-to-print">
            ...
            <!-- Sample Table -->
                ...
                <img src="../images/smartnetstore.png" alt="" class="daphnislogo" style="max-width: 230px;  max-height: 60px; "> 
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <p>I <?php echo $clientname ?> hereby authorize  <b>SmartNet Store </b> to charge the above credit card for fees associated with services provided. I agree that the onetime charge will be applied to my credit card by SmartNet Store   I agree that if I have any problems or questions regarding my account or any services provided by SmartNet Store, I will contact SmartNet Store for assistance. I guarantee and warrant that I am the legal card holder for this credit card and that I am legally authorized to enter into this credit card billing agreement with SmartNet Store </p>
                    </div>
                ...
                <br>
                <br>
                <img src="../images/smartnetstore-footer.png" alt="" class="w-100 d-footer-1" style="margin-top: 115px;">
            ...
            <br>
                <img src="../images/smartnetstore-footer.png" alt="" class="w-100 pt-2" style="margin-top: 187px;">
            </div>
            ...
            <div class="border d-2" style=" min-height: 1040px;">
                ...
                <br>
                <br>
                <img src="../images/smartnetstore-footer.png" alt="" class="w-100 mt-4 pt-5">
            ...
            <div class="border bottom-bordered p-0" style="height:1045px;">
                <!-- Sample Table -->
                    <div style="padding: 30px  30px 10px 30px;">
                        <img src="../images/smartnetstore.png" alt="" class="daphnislogo mb-4" style="max-width: 230px;  max-height: 60px; "> 
                    ...
                    <div style="padding: 30px  30px 10px 30px;">
                            <div class="row g-5">
                                <div class="col-6">
                                    ...
                                    <h6 style="font-size: 17px; font-weight: bold;" class="mb-1">SMARTNET STORE</h6>

                                    <br>
                                    <p class="mb-1" style="font-size: 13px;"><b>Website: </b>www.smartnetstore.com</p>
                                    <p class="mb-1" style="font-size: 13px;"><b>Email: </b>support@smartnetstore.com</p>
            ...
            <div class="border bottom-bordered"  style="min-height: 1040px;">
                ...
                <ol>
                    ...
                    <li><b>Terms of Use: </b><br> SMARTNET STORE ("SmartNet Store," "we," "us," and "our") reserves the right to change, modify, add, or remove any of the terms and conditions contained in above policies or guidelines governing the Site or Services, at any time and in its sole discretion. Any changes will be effective upon posting of the revisions on the Site. All notice of changes to this Policy will be posted on the Site for thirty (30) days. You are responsible for reviewing the notice and any applicable changes. Changes to referenced policies and guidelines may be posted without notice to you. </li>
                    <li>You’re continued use of this site and the services, any changes or updates posted by SmartNet Store will constitute your acceptance of such changes or modifications. If you do not agree to any changes to this participation agreement, do not continue to use the services or this site. If you have any questions or concerns, please contact us at “Support@smartnetstore.com ".</li>
            ...
            <div class="border bottom-bordered"  style="min-height: 1040px;">
                <br>
                <br>
                <p><b>How to contact</b> SMARTNET STORE :</p>
                ...
                <b class="mb-2"><b>SMARTNET STORE </b> </b>
                <p class="mb-0 mt-3"><b>Website: </b> www.smartnetstore.com </p>
                <p class="mb-0"><b>Email: </b>: support@smartnetstore.com</p>
                <br>

                
                <p><b>To advise </b> SMARTNET STORE  <b> of your new email address</b></p> 
                
                <p>To let us know of a change in your email address where we should send notices and disclosures electronically to you, you must send an email message to us at Support@smartnetstore.com   and in the body of such request, you must state: your previous email address, your new email address. We do not require any other information from you to change your email address.</p>
                <p><b>To withdraw your consent with</b> SMARTNET STORE </p>
                <p>To inform us that you no longer wish to receive future notices and disclosures in electronic format you may:</p>
                <ul><li>Send us an email at Support@smartnetstore.com   and in the body of such request you must state your email, full name, mailing address, and telephone number. We do not need any other information from you to withdraw consent.</li></ul>
            </div>
            ...
            <div class="border bottom-bordered" style="border-color: #fff !important;">
                <div><img src="../images/smartnetstore.png" alt="" class="daphnislogo mb-4"  style="max-width: 230px;  max-height: 60px; "> </div> 
                <h3  class="center-title mt-4 mb-3"> CUSTOMER FEEDBACK FORM </h3> <br>   

                <p>We at SMARTNET STORE, want to thank you for giving us the opportunity to serve you. Please help us by taking a couple of minutes to tell us about your experience. We appreciate your business and want to make sure we meet your expectations. </p>
                ...
                <img src="../images/smartnetstore-footer.png" alt="" class="w-100" style="margin-top: 220px;">
