...
$sql = "SELECT * FROM docu_form WHERE user_id = '$id' ORDER BY id DESC";
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <div>
        <a href="/docu" class="list-button">All Docu</a>
        <a href="/docu-form" class="create-button">Create New Docu</a>
      </div>
      </div>
          ...
          <tbody>
              ...
              if($result){
                while($row = mysqli_fetch_assoc($result))
                {
                  ...
                  <td>'.$user.'</td>
                  <td >
                  <a href="/pdf/'.$str.'?pdfid='.$id.'" class="tbl-btn download me-1" data-bs-toggle="tooltip" data-bs-placement="top" title="PDF">
                    <img src="../images/pdf.svg">
                  </a>
                  <a href="/update?updateid='.$id.'" class="tbl-btn edit me-1" data-bs-toggle="tooltip" data-bs-placement="top" title="EDIT">
