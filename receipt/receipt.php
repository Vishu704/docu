...
$sql = "SELECT * FROM order_receipt ORDER BY id DESC ";
 ...
 <style>
  ...
  <body>
    ...
    <div class="container">
      ...
      <a href="/receipt/receipt-list.php" class="create-button">Back</a>
      </div>
          ...
          <tbody>
              ...
              if($result){
                while($row = mysqli_fetch_assoc($result))
                {
                  ...
                  <td>'.$user.'</td>
                  <td>
                  <a href="/receipt/pdf/'.$str.'.php?pdf_id='.$id.'" class="tbl-btn download me-1" data-bs-toggle="tooltip" data-bs-placement="top" title="PDF">
